---
description: >-
  Executable project slices under the Haunted Toaster Living Creative Playground
  beta umbrella.
---

# Executable Beta Tracks
...
[Issue #149 — MUTATE / CROSS / MOLT / HAUNT](https://github.com/the-static-collective/the-haunted-toaster/issues/149)

Creates one versioned transformation law for the minimum beta verb grammar. Every act must remain deterministic, lock-safe, inspectable, upstream of rendering, and capable of explicit refusal rather than silent no-op success.

## Track 3 — Lawful Joy

[Issue #150 — one delightfully-elsewhere slot + no fake diversity](https://github.com/the-static-collective/the-haunted-toaster/issues/150)

Allows at most one lawful-surprise role per family, optimized for semantic distance rather than amplitude, and introduces explicit refusal when constraints leave no meaningful new blood.

## Track 4 — Lineage + creative memory

[Issue #151 — ancestry, influence, and Elsewhere](https://github.com/the-static-collective/the-haunted-toaster/issues/151)
