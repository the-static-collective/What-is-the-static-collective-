---
description: >-
  One hostile end-to-end specimen of attributable becoming across Project0,
  Corpus OS, and TranchNode without merged authority.
icon: bowl-food
---
...
flowchart TD
    ...
    U --> X["Attempt"]
    X --> O["Outcome"]
    O --> C["Causal accounting"]
    C --> W["WorldCut"]
    W --> K["Continuity"]
    K --> R["Return"]
    R --> L["Reachability"]
    M["MADDCL0WN"] -. "attributable material only" .-> E
    M -. "forgery and collapse pressure" .-> A
```
