---
description: "Dated, source-linked public Git inventory for the Static Collective."
---
...
[Living map](https://the-static-collective.gitbook.io/the-static-collective-docs/living-git-map/atlas) · [Machine-readable snapshot](public-index.json) · [GitHub owner](https://github.com/the-static-collective)
...
The [collector](https://github.com/the-static-collective/What-is-the-static-collective-/blob/main/scripts/refresh_git_atlas.py) reads GitHub's public
repository list, every branch ref, and every open PR. The
[daily workflow](https://github.com/the-static-collective/What-is-the-static-collective-/actions/workflows/refresh-git-atlas.yml) reruns it.
