...
* Status reconciliation/current main: commit `231eb8a8bb5102b008ea7c514d53a7ba5ee29550`
...
* Status reconciliation/current main: commit `7e1626aa65e137f3dbf1871c760a5dc8693abd1e`
...
The inhabited Garden encounter loop still composes TranchNode, Project 0, explicit human confirmation, Corpus OS destination-local admission, and Full Measure-local residue. Three additional surfaces are now landed:
...
Collision Specimen 001 landed as squash commit `4da374f52d7e2079481b3d71c1ee9a29f7557a39` after its exact-head `check` and `boot-house-proof` workflows passed. Its residue influence remains projection/testimony only: the specimen creates no new crossing path, authority transfer, automatic descendant invocation, or destination constitution from refusal or indeterminacy.
...
* Collision proof: commit `4da374f52d7e2079481b3d71c1ee9a29f7557a39`
* Status reconciliation/current main: commit `c03fb40394c0237ae3d0011aaef537aeba438afc`
...
* **The Haunted Toaster** has the BETA spine on current main, **Candidate Ecology + exact two-parent CROSS**, **BETA Home Bench**, persistent Video/VSPantry, receipt-backed Toaster Memory, and the landed **second six-up contextual move deck** from PR #189. Proposal dealing remains a deterministic renderer-local projection; choosing a move delegates to existing candidate operations, and `Use selected timeline` remains the production-binding step. Design/frontier notes do not outrank current main.
